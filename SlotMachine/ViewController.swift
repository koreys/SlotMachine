...
class ViewController: UIViewController {
    ...
    func setupThirdContainer(containerView: UIView){
        ...
        creditsLabel.font = UIFont(name: "HelveticaNeue-Light", size: 16)
        ...
        betLabel.font = UIFont(name: "HelveticaNeue-Light", size: 16)
        betLabel.sizeToFit()
        ...
        self.winnerPaidLabel.font = UIFont(name: "HelveticaNeue-Light", size: 16)
        ...
        self.creditsTitleLabel.font = UIFont(name: "HelveticaNeue-Light", size: 14)
        ...
        self.betTitleLabel.font = UIFont(name: "HelveticaNeue-Light", size: 14)
        ...
        self.winnerPaidTitleLabel.font = UIFont(name: "HelveticaNeue-Light", size: 14)
