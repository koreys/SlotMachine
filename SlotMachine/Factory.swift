...
//  SlotMachine
//
//  Created by Korey Stanley on 12/3/14.
...
class Factory {
    ...
    class func createSlot(currentCards: [Slot]) -> Slot {
        ...
        var randomNumer = Int(arc4random_uniform(UInt32(13)))
        
        while contains(currentCardValues, randomNumer + 1) {
            randomNumer = Int(arc4random_uniform(UInt32(13)))
        }
